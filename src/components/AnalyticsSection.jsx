      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex space-x-4 mb-6">
          ...
          <div className="flex-1 text-right space-x-4">
            <button className="px-4 py-2 bg-white border border-gray-300 hover:scale-110 rounded-lg">Customize</button>
            <button className="px-4 py-2 bg-white border border-gray-300 hover:scale-110 rounded-lg">Auto-refresh</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
          {/* Total Sales */}
          <div className="bg-white hover-box-shadow transition-all p-6 rounded-lg shadow-sm border border-gray-200">
